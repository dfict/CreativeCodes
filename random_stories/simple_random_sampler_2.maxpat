...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 18.0,
					"id" : "obj-2",
					"items" : [ "anton", ",", "brushes", ",", "cello-f2", ",", "cherokee", ",", "drumLoop", ",", "duduk", ",", "jongly", ",", "rainstick", ",", "senita-8ch", ",", "sho0630", ",", "vibes-a1" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 719.0, 408.0, 216.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 286.428513944149017, 30.0, 161.0, 45.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.428513944149017, 65.0, 158.0, 45.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 537.0, 300.0, 29.5, 22.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 357.428513944149017, 313.038551093570732, 96.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 357.428513944149017, 274.0, 113.0, 33.0 ],
...
, 			{
				"box" : 				{
					"allowdrag" : 0,
					"buffername" : "footstep.4",
					"id" : "obj-27",
					"maxclass" : "waveform~",
					"numinlets" : 5,
					"numoutlets" : 6,
					"outlettype" : [ "float", "float", "float", "float", "list", "" ],
					"patching_rect" : [ 409.312413153137186, 535.380959093570709, 256.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 409.428624153137207, 491.380959093570709, 82.0, 23.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 409.428624153137207, 448.026648284427665, 121.0, 23.0 ],
					"text" : "sprintf footstep.%i"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 121.0, 346.0, 133.0, 23.0 ],
									"saved_object_attributes" : 									{
										"embed" : 0
									}
,
									"text" : "polybuffer~ footstep"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 244.5, 378.0, 263.0, 378.0, 263.0, 256.0, 284.5, 256.0 ],
									"source" : [ "obj-279", 1 ]
								}
...
,
					"patching_rect" : [ 34.928513944149017, 220.595240414142609, 167.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 230.928513944149017, 498.380959093570823, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 205.928513944149017, 456.380959093570709, 130.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 73.428513944149017, 543.88089809357075, 107.0, 31.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"text" : "combine footstep. i @triggers 1"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 113.642805516719818, 313.038551093570732, 32.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 113.642805516719818, 285.130959093570709, 51.0, 22.0 ],
					"text" : "random"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 277.428513944149017, 137.0, 107.0, 23.0 ],
					"text" : "C74:/media/msp/"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 277.428513944149017, 81.095240414142609, 176.0, 49.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 175.428513944149017, 281.0, 113.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 73.428513944149017, 598.333352982997894, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 25.428513944149017, 54.0, 167.0, 67.0 ]
				}
